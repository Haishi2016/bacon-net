"""
CREAM on CUB (end-to-end fine-tuned ResNet-18) -> (CREAM, CUB) ACC_Y/ACC_C.

Full CREAM (concept pathway + regularized side-channel ON).

    python cream-cub-accuracy.py --iters 3 --epochs 30
"""
