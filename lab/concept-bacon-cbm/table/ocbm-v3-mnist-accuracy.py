"""
OCBM v3 on MNIST -> (OCBM v3, MNIST) ACC_Y.

v3 = the same fixed per-digit BACON tree structure, but its aggregators are
data-fine-tuned (FixedGLTree, gl.generic): each AND/OR node's andness and
per-input weights are trained while the topology stays frozen.

    python ocbm-v3-mnist-accuracy.py --iters 10
"""
...
MODEL_FT, COL, LABEL = True, "MNIST", "OCBM v3"
