"""OCBM v1 (GL trees) on cFMNIST -> ACC_Y/ACC_C. Fixed GL trees over the complete
cFMNIST concept set (apparel sub-score + season); v2 collapses to v1."""
...
DATASET, TRAINABLE, COL, LABEL = "cfmnist", False, "cFMNIST", "OCBM v1 (GL)"
