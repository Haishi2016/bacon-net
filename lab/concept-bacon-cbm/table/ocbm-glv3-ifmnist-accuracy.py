"""OCBM v3 (GL trees) on iFMNIST -> ACC_Y/ACC_C. The v2 (sFMNIST) GL tree structure
kept fixed, with each node's andness + per-input weights data-fine-tuned. See
OCBM_V1_TREE_PROMPT.md."""
...
DATASET, TRAINABLE, COL, LABEL = "sfmnist", True, "iFMNIST", "OCBM v3 (GL)"
