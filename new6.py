...
MAX_VAR_OCCURRENCES = 1  # Adjust this to limit variable appearances
DEPTH_PENALTY = 0.03  # Strength of penalty for deeper trees
...
# Fitness function with tree depth penalty
def fitness(tree, dataset):
    """Compute fitness with penalty for deep trees."""
    errors = []
