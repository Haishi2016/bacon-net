...
# Train/test split
X_train_np, X_test_np, y_train_np, y_test_np = train_test_split(X, y, test_size=0.2, random_state=77)
...
bacon = baconNet(input_size=X.shape[1], freeze_loss_threshold=0.14)
