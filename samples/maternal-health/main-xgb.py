"""XGBoost baseline for Maternal Health Risk Dataset"""
import numpy as np
...
def evaluate_model(model, X_train, X_test, y_train, y_test, feature_names):
    ...
    print("\nClassification Report:")
    print(classification_report(y_test, y_test_pred, target_names=['Not High Risk', 'High Risk']))
...
def main():
    ...
    print("="*80)
    print("XGBOOST BASELINE - MATERNAL HEALTH RISK")
    print("="*80)
    ...
    print(f"\nClass distribution: Not High Risk={neg_count}, High Risk={pos_count}")
