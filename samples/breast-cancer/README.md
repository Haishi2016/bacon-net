...
##  Saved models
| Model file | Accuracy | freeze_loss_threshold| weigth_model| weight_penalty_strength| aggregator | weight_normalization|
|--------|--------|--------|--------|--------|--------|--------|
| assembler.pth-9596-softmax-e4 | 95.96% | 0.035 | trainable | 1e-4 | lsp.full_weight | softmax |
