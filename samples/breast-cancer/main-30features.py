...
# 195 - 96.49%
# 140 - 94.55%
bacon = baconNet(input_size=7, freeze_loss_threshold=70, loss_amplifier=1000, is_frozen=True, weight_penalty_strength=1e-2, weight_mode='fixed')
(best_model, best_accuracy) = bacon.find_best_model(X_train, Y_train, X_test, Y_test, attempts=100, acceptance_threshold=0.90, max_epochs=3600, save_path='assembler-30features.pth')
