"""XGBoost baseline for Hepatitis Dataset"""
import numpy as np
...
def evaluate_model(model, X_train, X_test, y_train, y_test, feature_names):
    ...
    print("\nClassification Report:")
    print(classification_report(y_test, y_test_pred, target_names=['Live', 'Die']))
...
def main():
    ...
    print("="*80)
    print("XGBOOST BASELINE - HEPATITIS")
    print("="*80)
    ...
    print(f"\nClass distribution: Live={neg_count}, Die={pos_count}")
